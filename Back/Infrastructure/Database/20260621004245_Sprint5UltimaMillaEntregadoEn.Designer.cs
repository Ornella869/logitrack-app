...
namespace Back.Infrastructure.Database
{
    ...
    [Migration("20260621004245_Sprint5UltimaMillaEntregadoEn")]
    partial class Sprint5UltimaMillaEntregadoEn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Back.Domain.Models.AlertaRiesgoDemoraMl", b =>
                {
                    ...
                    b.Property<bool>("Gestionada")
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("GestionadaEn")
                        .HasColumnType("timestamp with time zone");

                    b.Property<bool?>("LlegoATiempo")
                        .HasColumnType("boolean");

                    b.Property<Guid>("PaqueteId")
                        .HasColumnType("uuid");

                    b.Property<float>("ProbabilidadDemora")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Back.Domain.Models.DatoEntrenamientoTramo", b =>
                {
                    ...
                    b.Property<int>("CargaSucursalOrigen")
                        .HasColumnType("integer");

                    b.Property<int>("DiaSemana")
                        .HasColumnType("integer");

                    b.Property<double?>("ErrorAbsolutoHoras")
                        .HasColumnType("double precision");

                    b.Property<bool>("EsPrioritario")
                        .HasColumnType("boolean");

                    b.Property<double?>("EstimacionPreviaHoras")
                        .HasColumnType("double precision");
                    ...
                    b.Property<int>("RepartidoresActivosDestino")
                        .HasColumnType("integer");
                    ...
                    b.Property<Guid?>("TramoId")
                        .HasColumnType("uuid");

                    b.Property<bool>("TuvoDemora")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Back.Domain.Models.Empresa", b =>
                {
                    ...
                    b.Property<int>("LicenciasAlertaDias")
                        .HasColumnType("integer");

                    b.Property<int>("LicenciasHoraProcesoMinutos")
                        .HasColumnType("integer");

                    b.Property<int>("LicenciasUrgenteDias")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Back.Domain.Models.Sucursal", b =>
                {
                    ...
                    b.Property<int>("CapacidadAlmacenamientoPaquetes")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Back.Domain.Models.Gerente", b =>
                {
                    ...
                    b.Property<Guid?>("SucursalActivaId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Back.Domain.Models.Repartidor", b =>
                {
                    ...
                    b.Property<double>("CapacidadCargaKg")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("double precision")
            ...
            modelBuilder.Entity("Back.Domain.Models.HorarioPickUp", b =>
                {
                    b.HasOne("Back.Domain.Models.PuntoPickUp", null)
                        .WithMany()
                        .HasForeignKey("PuntoPickUpId")
            ...
            modelBuilder.Entity("Back.Domain.Models.PermisoUsuario", b =>
                {
                    b.HasOne("Back.Domain.Models.Usuario", null)
                        .WithMany()
